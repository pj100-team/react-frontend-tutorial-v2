...
const Home: React.FC = () => {
  ...
  const [checkedListTile, setCheckedListTile] = React.useState(false);
  ...
  <PageWrapper color={BackgroundColor.SubBackground}>
    ...
    <ListTile title="List title" subtitle="Very Very Very Very Very Long List subtitle" checked={checkedListTile} setChecked={setCheckedListTile}></ListTile>
  </PageWrapper>
);
}
